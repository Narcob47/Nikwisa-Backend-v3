...
#     title = models.CharField(max_length=255)
#     slug = models.SlugField(max_length=255, unique=True, blank=True)
#     image = models.ImageField(upload_to='event_planning_categories/', blank=True, null=True)  # Image field
#     categories = models.ManyToManyField(Category, related_name='event_planning_categories')  # Change to many-to-many field
